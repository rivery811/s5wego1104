...
brd_vue = {
	...
	brd_body: ()=>{
		...
		'      <div id = "recent" class="my-3 p-3 bg-white rounded box-shadow">'+
	...
	brd_write: x=>{
		  ...
		  +'<form id = "write_form">' //$('#write_form'한칸띄고 input[name=writer])
		  //폼태그가 하나면 아이디 없애고 - 유니크 하니까  태그를 쓸 수 있어 
		  +'<input type="text" name="writer" style="margin-top:20px" class="form-control" />'
		  +'<input type="text" name="title" style="margin-top:20px" class="form-control" /><br />'
		  +'<div class="row">'
